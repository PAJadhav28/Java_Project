...
public class InstructionFrame extends JFrame implements ActionListener,ItemListener
{
	JPanel ipan;
	...
	public InstructionFrame(String ttl)
	{
		super(ttl);
...
//		ipan.add(i5);
	...
	public static void setInstruction4(String ins)
	{
		i4.setText(ins);
	}
	public static void setInstruction5(String ins)
	{
		i5.setText(ins);
	}
